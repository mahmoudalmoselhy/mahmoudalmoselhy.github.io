    ...
    <section id="contact" className="py-12 md:py-20 px-4 md:px-6">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="max-w-4xl mx-auto px-2">
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl md:rounded-3xl p-4 md:p-12 hover:bg-white/15 transition-all duration-500 border border-white/20">
            <div className="grid md:grid-cols-2 gap-6 md:gap-12">
                ...
                <div className="space-y-4 md:space-y-6">
                  <div className="flex items-center space-x-3 md:space-x-4">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <a href="mailto:mahmoudalmoselhy@gmail.com" className="text-white hover:text-teal-400 transition-colors text-sm md:text-base break-all">
                  ...
                  <div className="flex items-center space-x-3 md:space-x-4">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <a href="tel:+201121529292" className="text-white hover:text-teal-400 transition-colors text-sm md:text-base">
                        +20 112 152 9292
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3 md:space-x-4">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <a 
                        ...
                        className="text-white hover:text-teal-400 transition-colors flex items-center space-x-1 text-sm md:text-base"
                      >
              ...
              <div className="bg-white/5 rounded-xl md:rounded-2xl p-4 md:p-8 border border-white/10">
                <h4 className="text-lg md:text-xl font-semibold text-white mb-4 md:mb-6">What I Offer</h4>
