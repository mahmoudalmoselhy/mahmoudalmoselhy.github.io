...
export const PortfolioCard = ({ title, description, link, logo, thumbnail, client, date, skills = [] }: PortfolioCardProps) => {
  ...
  return (
    ...
    >
      <article className="rounded-2xl border border-border bg-card text-card-foreground shadow-sm hover:shadow-md transition-shadow duration-300">
        ...
        <Card className="rounded-none border-0 shadow-none bg-transparent">
          <CardContent className="p-4 md:p-6">
            ...
            <p className="text-muted-foreground text-xs md:text-sm leading-relaxed mb-2 md:mb-3 line-clamp-3">
              {description}
            </p>
