...
export const PortfolioItem = ({ title, description, link, logo }: PortfolioItemProps) => {
  return (
    <a
      ...
      className="group bg-card rounded-3xl p-4 md:p-6 cursor-pointer transform border border-border transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:border-primary/30"
    >
