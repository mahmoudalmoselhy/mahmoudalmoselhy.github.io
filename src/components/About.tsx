        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {highlights.map((item, index) => (
              <div 
                key={index}
                className="bg-secondary rounded-2xl p-8 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl border border-border hover:border-primary/30 hover:bg-gradient-to-br hover:from-secondary hover:to-primary/5"
