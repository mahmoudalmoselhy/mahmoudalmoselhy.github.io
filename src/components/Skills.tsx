      ...
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {skillCategories.map((category, index) => (
            <div 
              key={index}
              className="bg-card rounded-2xl p-8 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl group border border-border hover:border-primary/30 hover:bg-gradient-to-br hover:from-card hover:to-primary/5"
