          ...
          {portfolioSections.map((section, sectionIndex) => (
            <div key={sectionIndex} className="space-y-6 md:space-y-8">
              <div className="text-center px-4">
                ...
                <p className="text-slate-400 text-sm md:text-lg">{section.description}</p>
              </div>
                ...
                {section.items.map((item, itemIndex) => {
                  return (
                    <a
                      ...
                      className="group bg-slate-800/50 backdrop-blur-lg rounded-xl md:rounded-2xl p-4 md:p-6 hover:bg-slate-700/60 transition-all duration-300 hover:scale-105 hover:shadow-xl border border-cyan-500/20 hover:border-cyan-400/40"
                    >
